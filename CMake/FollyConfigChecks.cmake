...
if (BLUESKY OR TIZEN_NACL OR PS4 OR UWP)
  # These are largely only used by the tests anyways
  ...
  set(FOLLY_HAVE_LINUX_VDSO OFF CACHE INTERNAL "")
  set(FOLLY_HAVE_XSI_STRERROR_R OFF CACHE INTERNAL "")
